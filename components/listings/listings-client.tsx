              ...
              <Card key={l.id}>
                <CardContent className="p-3 flex gap-3 items-start">
                  ...
                  <div className="flex flex-col gap-1 shrink-0">
                    ...
                    {a.canSubmit && <Button size="sm" disabled={rowBusy(l.id)} onClick={() => doSubmit(l.id)}>{busy.has(`${l.id}:submit`) ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <Send className="h-3.5 w-3.5" />}出品申請</Button>}
